...
const courseSidebar = () => {
  ...
  return (
   ...
   <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-600 min-h-screen">
      <ul class="space-y-2">
         <li>
            <a href={"/core/lms/teacher/course/feed"} class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
         ...
         <li>
            <button type="button" class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                  ...
                  <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Assignments</span>
